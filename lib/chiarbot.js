...
/** @type {Client} */
const client = new tmi.Client(configOptions);
...
const botConnected = client.connect();

const AWSEnabled = process.env.ENABLE_AWS == 'TRUE'
...
Promise.all([botConnected,channelsLoaded]).then(([[addr,port]]) => {
