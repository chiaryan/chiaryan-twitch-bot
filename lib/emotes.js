 ...
 * @param {string} emote 
 */
function emoteFallback(channel, startEmote) {
...
module.exports = {
    ...
    reloadGlobalEmotes, reloadChannelEmotes, emoteFallback
}